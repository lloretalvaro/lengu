    ...
    public func checkForPermissions() {
        ...
        default:
            ...
            DispatchQueue.main.async {
                self.alertError = AlertError(title: "Camera Access", message: "Lengu doesn't have access to use your camera, please update your privacy settings.", primaryButtonTitle: "Settings", secondaryButtonTitle: nil, primaryAction: {
